...
func TestScenarioOrchestrator_Podman_RunAttached(t *testing.T) {
	config := scenarioorchestratortest.CommonGetTestConfig(t)
	sopodman := ScenarioOrchestrator{Config: config, ContainerRuntime: models.Podman}
	scenarioorchestratortest.CommonTestScenarioOrchestratorRunAttached(t, &sopodman, config, 10)
}

func TestScenarioOrchestrator_Podman_Run(t *testing.T) {
	config := scenarioorchestratortest.CommonGetConfig(t)
	sopodman := ScenarioOrchestrator{Config: config, ContainerRuntime: models.Podman}
	scenarioorchestratortest.CommonTestScenarioOrchestratorRun(t, &sopodman, config, 5)
}

func TestScenarioOrchestrator_Podman_RunGraph(t *testing.T) {
	config := scenarioorchestratortest.CommonGetConfig(t)
	sopodman := ScenarioOrchestrator{Config: config, ContainerRuntime: models.Podman}
	scenarioorchestratortest.CommonTestScenarioOrchestratorRunGraph(t, &sopodman, config)
}
...
func TestScenarioOrchestrator_Podman_CleanContainers(t *testing.T) {
	config := scenarioorchestratortest.CommonGetTestConfig(t)
	sopodman := ScenarioOrchestrator{Config: config, ContainerRuntime: models.Podman}
	scenarioorchestratortest.CommonTestScenarioOrchestratorRunAttached(t, &sopodman, config, 5)
...
func TestScenarioOrchestrator_Podman_Kill(t *testing.T) {
	config := scenarioorchestratortest.CommonGetConfig(t)
	sopodman := ScenarioOrchestrator{Config: config, ContainerRuntime: models.Podman}
	scenarioorchestratortest.CommonTestScenarioOrchestratorKillContainers(t, &sopodman, config)
...
func TestScenarioOrchestrator_Podman_ListRunningContainers(t *testing.T) {
	config := scenarioorchestratortest.CommonGetConfig(t)
	sopodman := ScenarioOrchestrator{Config: config, ContainerRuntime: models.Podman}
	scenarioorchestratortest.CommonTestScenarioOrchestratorListRunningContainers(t, &sopodman, config)
}

func TestScenarioOrchestrator_Podman_ListRunningScenarios(t *testing.T) {
	config := scenarioorchestratortest.CommonGetConfig(t)
	sopodman := ScenarioOrchestrator{Config: config, ContainerRuntime: models.Podman}
	scenarioorchestratortest.CommonTestScenarioOrchestratorListRunningScenarios(t, &sopodman, config)
}
